  ...
  return (
    <div className="checkout-container">
      <div className="summary-section">
        ...
        <h2 className="summary-title">Suscribirse al Plan Plata</h2>

        <div className="price">
          <h3>USD 45 / mes</h3>
          <p>Hasta 150 usuarios, ideal para equipos en crecimiento</p>
        </div>
        ...
        <div className="summary-box">
          ...
          <div className="summary-item">
            ...
            <span>Chat anónimo activo, tablero con dependencias</span>
          </div>
          <div className="summary-item">
            <span>Estadísticas</span>
            <span>Panel de estadísticas disponible</span>
          </div>
          <div className="summary-total">
            <span>Total a pagar</span>
            <span>USD 45 / mes</span>
          </div>
        </div>
      </div>
...
export default MetodoPagoPlata;
